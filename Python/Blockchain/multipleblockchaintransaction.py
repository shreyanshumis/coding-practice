...
# Loop through each receiver and create a transaction
for receiver in receiverAddresses:
    # Create the transaction
    transaction = {
        'to': receiver,
        'value': web3.toWei(0.01, 'ether'),  # Sending 0.01 Ether to each receiver
        'gas': 21000,
    ...
    print(f"Transaction to {receiver} successful with hash: {web3.toHex(txHash)}")
